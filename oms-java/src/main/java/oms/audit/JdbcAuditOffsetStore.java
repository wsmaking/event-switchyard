...
public final class JdbcAuditOffsetStore implements AuditOffsetStore {
    ...
    public long readOffset() {
        String sql = "SELECT current_offset FROM oms_consumer_checkpoint WHERE consumer_name = ?";
        try (
    ...
    public void writeOffset(long offset) {
        String sql = """
            INSERT INTO oms_consumer_checkpoint (consumer_name, current_offset, updated_at)
            VALUES (?, ?, ?)
        ...
        try (
            ...
            throw new IllegalStateException("failed_to_write_oms_checkpoint:" + consumerName, exception);
        }
    }

    @Override
    public String describe() {
        return "db:oms_consumer_checkpoint/" + consumerName;
    }
}
