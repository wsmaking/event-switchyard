...
public final class BackOfficeInternalOrphanHttpHandler extends JsonHttpHandler {
    public BackOfficeInternalOrphanHttpHandler(GatewayAuditIntakeService intakeService) {
        super(exchange -> {
