...
V3_DURABLE_WORKER_DYNAMIC_INFLIGHT="${V3_DURABLE_WORKER_DYNAMIC_INFLIGHT:-true}"
V3_DURABLE_WORKER_DYNAMIC_INFLIGHT_MIN_CAP_PCT="${V3_DURABLE_WORKER_DYNAMIC_INFLIGHT_MIN_CAP_PCT:-5}"
V3_DURABLE_WORKER_DYNAMIC_INFLIGHT_MAX_CAP_PCT="${V3_DURABLE_WORKER_DYNAMIC_INFLIGHT_MAX_CAP_PCT:-80}"
...
V3_DURABLE_FSYNC_SOFT_INFLIGHT_CAP_PCT="${V3_DURABLE_FSYNC_SOFT_INFLIGHT_CAP_PCT:-70}"
V3_DURABLE_FSYNC_HARD_INFLIGHT_CAP_PCT="${V3_DURABLE_FSYNC_HARD_INFLIGHT_CAP_PCT:-35}"
...
V3_DURABLE_CONFIRM_GUARD_SOFT_REQUIRES_ADMISSION="${V3_DURABLE_CONFIRM_GUARD_SOFT_REQUIRES_ADMISSION:-true}"
V3_DURABLE_CONFIRM_GUARD_HARD_REQUIRES_ADMISSION="${V3_DURABLE_CONFIRM_GUARD_HARD_REQUIRES_ADMISSION:-true}"
V3_DURABLE_CONFIRM_GUARD_SECONDARY_REQUIRED="${V3_DURABLE_CONFIRM_GUARD_SECONDARY_REQUIRED:-true}"
