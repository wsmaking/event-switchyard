...
ack_accepted_tsc_p99_ns="$(read_value server_hotpath_accepted_tsc_p99_ns)"
...
pass_ack_accepted_tsc_ns="$(read_value gate_pass_live_ack_accepted_tsc_p99_ns)"
...
observed_ack_accepted_tsc_p99_ns=${ack_accepted_tsc_p99_ns}
...
gate_pass_ack_accepted_tsc_p99_ns=${pass_ack_accepted_tsc_ns}
...
echo "  - ack_accepted_tsc_p99_ns <= ${TARGET_ACK_ACCEPTED_TSC_P99_NS}: ${pass_ack_accepted_tsc_ns}"
