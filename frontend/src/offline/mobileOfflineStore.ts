...
const DRILL_DEFINITIONS: OfflineDrill[] = [
  ...
  {
    id: 'drill-institutional-flow',
    title: 'parent / child と配賦を説明する',
    category: '執行',
    prompt: 'parent order、child order、participation、allocation を一続きで説明する。',
    routes: ['/mobile/institutional', '/mobile/orders'],
    keywords: ['parent-child', 'participation', 'allocation'],
  },
  {
    id: 'drill-post-trade',
    title: 'execution 後の業務を説明する',
    category: '決済',
    prompt: 'execution、allocation、clearing、settlement、books and records の違いを順に説明する。',
    routes: ['/mobile/posttrade', '/mobile/ledger'],
    keywords: ['settlement', 'clearing', 'statement'],
  },
  {
    id: 'drill-risk-depth',
    title: 'concentration と liquidity を説明する',
    category: 'リスク',
    prompt: 'single-name concentration、liquidity、scenario library、backtesting をまとめて説明する。',
    routes: ['/mobile/risk'],
    keywords: ['concentration', 'liquidity', 'backtesting'],
  },
  {
    id: 'drill-asset-class-boundary',
    title: '資産別に何を共通化し、何を専用化するか説明する',
    category: '資産',
    prompt: 'equities、options、FX、rates、credit、futures を比較して、どこを共通化しどこを分けるかを説明する。',
    routes: ['/mobile/assets', '/mobile/cards'],
    keywords: ['multi-asset', 'boundary', 'valuation'],
  },
  {
    id: 'drill-operations-incident',
    title: '運用事故の最初の問いを説明する',
    category: '運用',
    prompt: 'sequence gap、pending orphan、DLQ、schema mismatch、market data stale をどう切り分けるか説明する。',
    routes: ['/mobile/operations', '/mobile/architecture'],
    keywords: ['incident', 'pending orphan', 'DLQ', 'schema'],
  },
];
...
export function getOfflineMobileHome(): MobileHome {
  ...
  return {
    ...
    quickActions: [
      ...
      { label: '執行判断を見る', route: '/mobile/institutional', tone: '執行' },
      { label: '決済を見る', route: '/mobile/posttrade', tone: '決済' },
      { label: '台帳フローを見る', route: '/mobile/ledger', tone: '台帳' },
      { label: '構成を見る', route: '/mobile/architecture', tone: '運用' },
      { label: '資産別比較', route: '/mobile/assets', tone: '資産' },
      { label: '運用工学', route: '/mobile/operations', tone: '運用' },
